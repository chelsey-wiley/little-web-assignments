...
//anytime you create a variable outside function it becomes a variable of the window. So you can view it in the console using window.var
...
promise.done(function(data){ // done function is a specific to jQuery (common on other libraries) function: promise that you will fire a function once you're done. Data is passed into the function parameters.
  ...
  studentList.appendChild(li); //add the li to the student list when actually creating/adding/removing HTML don't use . (dot) or it will add a . (dot) in the HTML as well.
  }
});
...
//data-index used for devs storing data in the dom PRN
